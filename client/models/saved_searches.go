...
type SavedSearchObject struct {
	...
	ActionCreateXsoarIncident                    int     `json:"action.create_xsoar_incident,omitempty" url:"action.create_xsoar_incident"`
	ActionCreateXsoarIncidentParamSendAllServers int     `json:"action.create_xsoar_incident.param.send_all_servers,omitempty" url:"action.create_xsoar_incident.param.send_all_servers"`
	...
	ActionCreateXsoarIncidentParamSeverity       int     `json:"action.create_xsoar_incident.param.severity,omitempty" url:"action.create_xsoar_incident.param.severity"`
	...
	ActionCreateXsoarIncidentParamType           string  `json:"action.create_xsoar_incident.param.severity" url:"action.create_xsoar_incident.param.severity"`
