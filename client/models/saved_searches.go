...
type SavedSearchObject struct {
	...
	ActionMsTeamsPublishToChannel                                                    bool    `json:"action.ms_teams_publish_to_channel,omitempty" url:"action.ms_teams_publish_to_channel"`
	ActionMsTeamsPublishToChannelCommand                                             string  `json:"action.ms_teams_publish_to_channel.command,omitempty" url:"action.ms_teams_publish_to_channel.command"`
	ActionMsTeamsPublishToChannelDescription                                         string  `json:"action.ms_teams_publish_to_channel.description,omitempty" url:"action.ms_teams_publish_to_channel.description"`
	ActionMsTeamsPublishToChannelHostname                                            string  `json:"action.ms_teams_publish_to_channel.hostname,omitempty" url:"action.ms_teams_publish_to_channel.hostname"`
	ActionMsTeamsPublishToChannelIconPath                                            string  `json:"action.ms_teams_publish_to_channel.icon_path,omitempty" url:"action.ms_teams_publish_to_channel.icon_path"`
	ActionMsTeamsPublishToChannelMaxresults                                          int     `json:"action.ms_teams_publish_to_channel.maxresults,omitempty" url:"action.ms_teams_publish_to_channel.maxresults"`
	ActionMsTeamsPublishToChannelMaxtime                                             string  `json:"action.ms_teams_publish_to_channel.maxtime,omitempty" url:"action.ms_teams_publish_to_channel.maxtime"`
	ActionMsTeamsPublishToChannelParamAlertMsTeamsActivityTitle                      string  `json:"action.ms_teams_publish_to_channel.param.alert_ms_teams_activity_title,omitempty" url:"action.ms_teams_publish_to_channel.param.alert_ms_teams_activity_title"`
	ActionMsTeamsPublishToChannelParamAlertMsTeamsFieldsList                         string  `json:"action.ms_teams_publish_to_channel.param.alert_ms_teams_fields_list,omitempty" url:"action.ms_teams_publish_to_channel.param.alert_ms_teams_fields_list"`
	ActionMsTeamsPublishToChannelParamAlertMsTeamsFieldsOrder                        string  `json:"action.ms_teams_publish_to_channel.param.alert_ms_teams_fields_order,omitempty" url:"action.ms_teams_publish_to_channel.param.alert_ms_teams_fields_order"`
	ActionMsTeamsPublishToChannelParamAlertMsTeamsImageLink                          string  `json:"action.ms_teams_publish_to_channel.param.alert_ms_teams_image_link,omitempty" url:"action.ms_teams_publish_to_channel.param.alert_ms_teams_image_link"`
	ActionMsTeamsPublishToChannelParamAlertMsTeamsPotentialActionName                string  `json:"action.ms_teams_publish_to_channel.param.alert_ms_teams_potential_action_name,omitempty" url:"action.ms_teams_publish_to_channel.param.alert_ms_teams_potential_action_name"`
	ActionMsTeamsPublishToChannelParamAlertMsTeamsPotentialActionName2               string  `json:"action.ms_teams_publish_to_channel.param.alert_ms_teams_potential_action_name2,omitempty" url:"action.ms_teams_publish_to_channel.param.alert_ms_teams_potential_action_name2"`
	ActionMsTeamsPublishToChannelParamAlertMsTeamsPotentialUrl                       string  `json:"action.ms_teams_publish_to_channel.param.alert_ms_teams_potential_action_url,omitempty" url:"action.ms_teams_publish_to_channel.param.alert_ms_teams_potential_action_url"`
	ActionMsTeamsPublishToChannelParamAlertMsTeamsPotentialUrl2                      string  `json:"action.ms_teams_publish_to_channel.param.alert_ms_teams_potential_action_url2,omitempty" url:"action.ms_teams_publish_to_channel.param.alert_ms_teams_potential_action_url2"`
	ActionMsTeamsPublishToChannelParamAlertMsTeamsPotentialPostactionBody            string  `json:"action.ms_teams_publish_to_channel.param.alert_ms_teams_potential_postaction_body,omitempty" url:"action.ms_teams_publish_to_channel.param.alert_ms_teams_potential_postaction_body"`
	ActionMsTeamsPublishToChannelParamAlertMsTeamsPotentialPostactionBodycontenttype string  `json:"action.ms_teams_publish_to_channel.param.alert_ms_teams_potential_postaction_bodycontenttype,omitempty" url:"action.ms_teams_publish_to_channel.param.alert_ms_teams_potential_postaction_bodycontenttype"`
	ActionMsTeamsPublishToChannelParamAlertMsTeamsPotentialPostactionName            string  `json:"action.ms_teams_publish_to_channel.param.alert_ms_teams_potential_postaction_name,omitempty" url:"action.ms_teams_publish_to_channel.param.alert_ms_teams_potential_postaction_name"`
	ActionMsTeamsPublishToChannelParamAlertMsTeamsPotentialPostactionTarget          string  `json:"action.ms_teams_publish_to_channel.param.alert_ms_teams_potential_postaction_target,omitempty" url:"action.ms_teams_publish_to_channel.param.alert_ms_teams_potential_postaction_target"`
	ActionMsTeamsPublishToChannelParamAlertMsTeamsThemeColor                         string  `json:"action.ms_teams_publish_to_channel.param.alert_ms_teams_theme_color,omitempty" url:"action.ms_teams_publish_to_channel.param.alert_ms_teams_theme_color"`
	ActionMsTeamsPublishToChannelParamAlertMsTeamsUrl                                string  `json:"action.ms_teams_publish_to_channel.param.alert_ms_teams_url,omitempty" url:"action.ms_teams_publish_to_channel.param.alert_ms_teams_url"`
	ActionMsTeamsPublishToChannelTrackAlert                                          bool    `json:"action.ms_teams_publish_to_channel.track_alert,omitempty" url:"action.ms_teams_publish_to_channel.track_alert"`
	ActionMsTeamsPublishToChannelTtl                                                 string  `json:"action.ms_teams_publish_to_channel.ttl,omitempty" url:"action.ms_teams_publish_to_channel.ttl"`
