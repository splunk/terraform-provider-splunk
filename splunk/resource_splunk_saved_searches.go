...
func getSavedSearchesConfig(d *schema.ResourceData) (savedSearchesObj *models.SavedSearchObject) {
	savedSearchesObj = &models.SavedSearchObject{
		...
		ActionCreateXsoarIncident:                    d.Get("action_create_xsoar_incident").(int),
		ActionCreateXsoarIncidentParamSendAllServers: d.Get("action_create_xsoar_incident_param_send_all_servers").(int),
		...
		ActionCreateXsoarIncidentParamSeverity:       d.Get("action_create_xsoar_incident_param_severity").(int),
