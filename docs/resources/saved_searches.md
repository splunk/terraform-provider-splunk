...
* `action_pagerduty_integration_url` - (Optional) The pagerduty integration token.
* `action_pagerduty_integration_url_override` - (Optional) The pagerduty integration token override.
